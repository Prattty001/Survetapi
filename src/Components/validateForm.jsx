const validateForm = (values) => {
    ...
    if (values.surveyTopic === 'Technology') {
      if (!values.favProgrammingLanguage) {
        errors.favProgrammingLanguage = 'Favorite Programming Language is required';
      }
      if (!values.techExperience) {
        errors.techExperience = 'Years of Experience is required';
      } else if (values.techExperience <= 0) {
        errors.techExperience = 'Years of Experience must be greater than 0';
      }
    }
